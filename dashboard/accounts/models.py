...
class DatabaseUserManager(BaseUserManager):
    ...
    def _create_user(self, username, email, password, is_staff, is_superuser, reply_to, **extra_fields):
        """
        ...
        user        = self.model(username=username, email=email,
                          ...
                          date_joined=now, reply_to=reply_to, **extra_fields)
        user.set_password(password)
        user.save(using=self._db)
        return user

    def create_user(self, username, email, password, reply_to, **extra_fields):
        return self._create_user(username, email, password, False, False, reply_to, **extra_fields)

    def create_superuser(self, username, email, password, reply_to, **extra_fields):
        return self._create_user(username, email, password, True, True, reply_to, **extra_fields)
...
class DatabaseUser(CustomAbstractUser):
